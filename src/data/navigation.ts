...
const MEGAMENU_DEMO: NavItemType[] = [
  {
    ...
    name: "Womens Fashion",
    children: [
      { id: ncNanoId(), href: "#", name: "Tops" },
      { id: ncNanoId(), href: "#", name: "Shirts" },
      { id: ncNanoId(), href: "#", name: "T-Shirts" },
      { id: ncNanoId(), href: "#", name: "Dresses" },
      { id: ncNanoId(), href: "#", name: "Jewellery" },
      { id: ncNanoId(), href: "#", name: "Accessories" },
    ],
  },
  {
    id: ncNanoId(),
  ...
  },
  {
    ...
    name: "Kids",
    children: [
      { id: ncNanoId(), href: "#", name: "Top Wear" },
      { id: ncNanoId(), href: "#", name: "Bottom Wear" },
      { id: ncNanoId(), href: "#", name: "Diapering Need" },
      { id: ncNanoId(), href: "#", name: "Accessories" },
    ],
  },
  // {
